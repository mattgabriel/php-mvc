...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	$img_r = imagecreatefromjpeg($src); //creates and image from url/path to original image
	$dst_r = imagecreatetruecolor($targ_w,$targ_h); //width,height

	imagecopyresampled($dst_r,$img_r,0,0,$_POST['x'],$_POST['y'],
	$targ_w,$targ_h,$_POST['w'],$_POST['h']);
	//Destination image link resource
	//Source image link resource
	//x-coordinate of destination image point
	//y-coordinate of destination image point
	//x-coordinate of source image point
	//y-coordinate of source image point
